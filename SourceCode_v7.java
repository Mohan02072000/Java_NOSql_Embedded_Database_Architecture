...
class scriptRunner {
    public static void main(String args[])throws IOException
    {
        ...
        System.out.println("                               |------------------Java-NOSql-EDMA----------v2.Mk-VII---|");
      ...
      // employee_table.insert(new String[]{"1005","Ranjan","16/07/2005","m","Engg","50000","20000","20000"});              |
       ...
       // employee_table.insert(new String[]{"1010","Rajeev","12/08/2016","m","Engg","26000","17000","10000"});             |
        ...
        FileOutputStream fos=new FileOutputStream((employee_table.toString())+".blo");              //create jnos file
...
class Console {
    ...
    public static void printLogo()
    {
        ...
        System.out.println("                                                          -:J-NOSql-EDMA:-                            -:v2.Mk-VII:-");
        System.out.println();
        System.out.println("                                                                                                                                      -------------");
