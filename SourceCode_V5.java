...
final class Table implements Serializable                                            //table Object class
{
    ...
    public String updateTable(String[] headers,String[] values, int[] indexes)                                                  //Update values in the entry as per 
    {
        ...
        return "Table update complete for "+Integer.toString(indexes.length)+" records";
    }
...
class v5testScript {
    public static void main(String args[])throws IOException
    {
        ...
        System.out.println("                               |------------------Java-NOSql-EDMA----------v2.Mk-V----|");
      ...
      // employee_table.insert(new String[]{"1005","Ranjan","16/07/2005","m","Engg","50000","20000","20000"});              |
       ...
       // employee_table.insert(new String[]{"1010","Rajeev","12/08/2016","m","Engg","26000","17000","10000"});             |
        ...
        FileOutputStream fos=new FileOutputStream("./ConsoleFiles/Source/"+employee_table.toString()+".jnos");              //create jnos file
...
class Console {
	...
	public static void CreateBlock() throws IOException,NullPointerException
	{
		String Input;
        String name;
		int col;
    ...
    public static void LoadBlock(String filename)throws IOException
    {
        try{
    ...
    public static void loadBlockFromFile(String filename)throws IOException
    {
        try{
    ...
    public static void xportBlock()throws IOException
    {
    ...
    public static void showCatalog()
    {
        ...
        System.out.println("|| LOAD BLOCK (new): Load a Block with its table from ./ConsoleFiles/Blocks/ file                              |   |");
        System.out.println("|| LOAD BLOCK FROM FILE(new): Load a Block with its table from ./ConsoleFiles/Source/ file                     |   |");
        ...
        System.out.println("|| CUSTOM INSERT TABLE: enter field names and corresponding data to insert                                     |-V |");
        ...
        System.out.println("|| EXPORT TABLE (new): save and export table in ./ConsoleFiles/Tables/ directory                               |   |");
        System.out.println("|| EXPORT VIEW (new):  save and export loaded view into the ./ConsoleFiles/Views/ directory as 2D array        |   |");
        System.out.println("|| EXPORT BLOCK(new) :  save and export loaded Block into the ./ConsoleFiles/Blocks/ directory                 |   |");
	...
	public static void main(String args[]) throws IOException
    {
		        ...
		        System.out.println("                                                          -:J-NOSql-EDMA:-                       -:v2.Mk-V:-");
        ...
        while(run)
        {
        	...
        	switch(Input)
        	{
                ...
                case "LOAD BLOCK":
                      ...
                      LoadBlock(Input);
                      break;
                case "LOAD BLOCK FROM FILE":
                      System.out.print("File name >");
                      Input=b.readLine();
                      loadBlockFromFile(Input);
                      break;                    
        		case "CREATE BLOCK":
        			CreateBlock();
        			break;
